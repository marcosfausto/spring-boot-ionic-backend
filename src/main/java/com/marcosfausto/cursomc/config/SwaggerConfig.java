...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.marcosfausto.cursomc.resources"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo(
                "API do curso Spring Boot, Sistema de pedidos",
                "Esta API é utilizada no curso de Spring Boot do prof. Nelio Alves",
                "Versão 1.0",
                "https://www.udemy.com/terms",
                new Contact("Marcos Fausto", "https://www.udemy.com/user/marcos-fausto-de-souza-pires/", "marcos.fausto123@gmail.com"),
